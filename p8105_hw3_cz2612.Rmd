...
ny_noaa %>% 
  ...
  ggplot(aes(x = year, y = mean_tmax, group = id)) + 
    ...
    geom_path(aes(alpha = 0.5, fill = id)) + 
    geom_smooth(se = FALSE) + 
    facet_grid(~ month) + 
    labs(title = "The average max temperature in January and July in each station across years", x = "Year", y = "Average maximum temperature (C)") 
```
